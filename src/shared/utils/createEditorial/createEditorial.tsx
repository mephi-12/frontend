...
import { MaterialNode } from '@entity/material'
import '@shared/styles/editotial.scss'
...
const renderItem = (node: MaterialNode) => {
    if (node.title) {
        return (
